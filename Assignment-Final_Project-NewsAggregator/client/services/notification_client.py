...
class NotificationClient:
    ...
    def get_user_notifications(self, user_id):
        try:
            ...
            return res.json() if res.ok else {"error": res.json().get("detail", "Failed to fetch notifications")}
        except Exception as e:
            return {"error": str(e)}
    ...
    def get_user_categories(self, user_id):
        try:
            ...
            return res.json() if res.ok else {"error": res.json().get("detail", "Failed to fetch user categories")}
        except Exception as e:
            return {"error": str(e)}
    ...
    def get_user_keywords(self, user_id):
        try:
            ...
            return res.json() if res.ok else {"error": res.json().get("detail", "Failed to fetch user keywords")}
        except Exception as e:
            return {"error": str(e)}
