...
class TestNewsFetcher(unittest.TestCase):
    ...
    def test_fetch_all(self, mock_categorizer, mock_api_repo, mock_thenewsapi, mock_newsapi):
        mock_api_repo.return_value.get_api_keys.return_value = {'NewsAPI': 'key1', 'TheNewsAPI': 'key2'}
        ...
        mock_categorizer.return_value.categorize_articles.return_value = ['catA', 'catB']
