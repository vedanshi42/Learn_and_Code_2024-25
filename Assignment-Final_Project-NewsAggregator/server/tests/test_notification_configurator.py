...
class TestNotificationsConfigurator(unittest.TestCase):
    ...
    @patch('server.services.notifications_service.notification_configurator.KeywordRepository')
    ...
    @patch('server.services.notifications_service.notification_configurator.CategoryRepository')
    ...
    @patch('server.services.notifications_service.notification_configurator.NotificationRepository')
